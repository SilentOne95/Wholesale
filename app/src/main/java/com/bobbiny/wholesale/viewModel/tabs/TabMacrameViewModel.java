...
import static com.bobbiny.wholesale.Constants.SECOND_CATEGORY;

public class TabMacrameViewModel extends AndroidViewModel {

    private WholesaleRepository mRepository;
    private MutableLiveData<List<Item>> mTabItems;

    public TabMacrameViewModel(@NonNull Application application) {
        super(application);
    ...
    private void getData(int id) {
        mRepository.getCategoryItems(id, SECOND_CATEGORY, new WholesaleDataSource.LoadDataCallback() {
            @Override
